...
<body onload="startclock()" id="glowna">
    <table id="tabelaglowna">
        <!-- Sekcja menu -->
        <tr>
            <td class="menu" id="tdglowna">
                <!-- Zegar i data -->
                <div class="zegar">
                    <div id="zegarek"></div>
                    <div id="data"></div>
                ...
                <a href="admin/admin.php">
                    <div class="pole animacjaTestowa">LOGOWANIE ADMINISTRATORA</div>
                </a>
                <a href="produkty.php">
                    <div class="pole animacjaTestowa">SKLEP</div>
                </a>
