...
<tr>
 ...
 <tr>
     <td class="content">
        ...
        $page = $_GET['page'] ?? 'glowna'; // Default to 'home' if 'page' is not set
        $allowed_pages = ['glowna', 'kontakt', 'Abradzal-Bajt', 'BurdzChalifa', 'Merdeka118', 'PingAnFinanceCenter', 'ShanghaiTower']; // Define allowed pages for security
